    ...
    <>
      <main className="w-full max-w-7xl mx-auto px-4 md:px-8 py-10 text-gray-800">
        ...
        <section className="mb-10">
          ...
          <ul className="text-white pl-5 mb-5">
        ...
        <br />
        <section className="text-white">
          <h1 className="text-[#DE2F04] text-3xl mb-4">Choice/Opt-Out</h1>
          <ul>
            <li>
              ...
              <span className="text-[#DE2F04]">care@bembexlab.com</span>
            </li>
            <li>
        ...
        <br />
        <section className="text-white">
          <h1 className="text-[#DE2F04] text-3xl mb-4">
        ...
        <br />
        <section className="text-white">
          <h1 className="text-[#DE2F04] text-3xl mb-4">Information Sharing</h1>
          <ul>
            <li>
              ...
              if bembex lab is involved in a merger, acquisition, or sale of all
        ...
        <br />
        <section className="text-white">
          <h1 className="text-[#DE2F04] text-3xl mb-4">Web beacons</h1>
          <ul>
            <li>
        ...
        <section className="text-white">
          ...
          <ul>
            <li>
              ...
              may differ from those of bembexlab. If you submit personal
        ...
        <br />
        <section className="text-white">
          <h1 className="text-[#DE2F04] text-3xl mb-4">Security</h1>
          <ul>
            <li>
